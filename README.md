...
| **按需想起** | 只在相关时才注入，无关零打扰。问 `VPS 怎么连` 就只带 VPS，问 `DSH 更新` 就一条不带。背后四步：① 聪明数词（稀有词分高，2-gram 中文切分）② 同义词联想（搜“部署”也能找到含“systemd”的记忆，搜“前端”也能带上“react”）③ 说得越多越靠前 ④ 越新越靠前；纯本地 BM25，无需 Key |
